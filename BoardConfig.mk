...
DEVICE_PATH := device/samsung/a71naxx
...
# Assert
TARGET_OTA_ASSERT_DEVICE := a71naxx

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 82726912 # This is the maximum known partition size, but it can be higher, so we just omit it
